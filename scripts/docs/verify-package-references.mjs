...
for (const file of files) {
  ...
  for (const value of item.types) {
    const declaration = value.declaration.replace(/\s*—\s*/g, ", ");
    if (!types.includes(declaration)) fail(file + ": missing type declaration " + value.name);
  }
