...
Import path: `github.com/looprig/llm/providers/vercel`. Package vercel provides Vercel AI Gateway's documented OpenAI Chat, Responses, and Anthropic Messages endpoints.
