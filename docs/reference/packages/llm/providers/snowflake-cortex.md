...
Import path: `github.com/looprig/llm/providers/snowflake-cortex`. Package snowflake provides Snowflake Cortex's documented OpenAI-compatible Chat Completions endpoint.
