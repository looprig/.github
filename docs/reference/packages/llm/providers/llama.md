...
Import path: `github.com/looprig/llm/providers/llama`. Package llama provides Meta's hosted Llama API through its documented OpenAI-compatible Chat Completions endpoint.
