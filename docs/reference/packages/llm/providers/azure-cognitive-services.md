...
Import path: `github.com/looprig/llm/providers/azure-cognitive-services`. Package azurecognitive provides Azure Cognitive Services' documented OpenAI and Anthropic-compatible model endpoints.
...
`CounterSupportError`, `Option`, `ResourceConfigurationError`, `ResourceConfigurationReason`
