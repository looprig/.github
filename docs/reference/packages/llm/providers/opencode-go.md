...
Import path: `github.com/looprig/llm/providers/opencode-go`. Package opencode provides the OpenCode Go endpoint using the shared Chat, Responses, and Anthropic transport semantics.
