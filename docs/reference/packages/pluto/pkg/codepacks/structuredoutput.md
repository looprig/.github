...
Package structuredoutput is Pluto's structured-output qualification pack: can the target produce schema-conformant output across shapes, and does it fail cleanly when it cannot.
...
- [pkg/codepacks/structuredoutput/v1.go](https://github.com/looprig/pluto/blob/a558d9006ba74559668d9929fb6d872cea0599b4/pkg/codepacks/structuredoutput/v1.go)

Adjacent tests at the same commit:

- [pkg/codepacks/structuredoutput/v1_test.go](https://github.com/looprig/pluto/blob/a558d9006ba74559668d9929fb6d872cea0599b4/pkg/codepacks/structuredoutput/v1_test.go)
