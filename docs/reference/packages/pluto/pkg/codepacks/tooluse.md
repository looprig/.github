...
Package tooluse is Pluto's tool-use qualification pack: does the target invoke tools when the task requires them, and does it stay disciplined (no unnecessary or forbidden tool calls) when it does not.
...
- [pkg/codepacks/tooluse/v1.go](https://github.com/looprig/pluto/blob/a558d9006ba74559668d9929fb6d872cea0599b4/pkg/codepacks/tooluse/v1.go)

Adjacent tests at the same commit:

- [pkg/codepacks/tooluse/v1_test.go](https://github.com/looprig/pluto/blob/a558d9006ba74559668d9929fb6d872cea0599b4/pkg/codepacks/tooluse/v1_test.go)
