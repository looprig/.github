...
Package capability is Pluto's core-capability qualification pack: instruction-following and known-answer cases that need no special target capability, just plain text conversation.
