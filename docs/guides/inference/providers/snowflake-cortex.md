---
id: guides/inference/providers/snowflake-cortex
title: Snowflake Cortex
description: Configure the Snowflake Cortex provider from its released llm package, including endpoint, auth, formats, capabilities, counters, and failure boundaries.
audience: developer
section: guides
order: 48
...
Snowflake Cortex Chat client translating max_tokens to max_completion_tokens and normalizing empty assistant roles.

## Contract and endpoint

The public constructor is `func New(selected model.Model, key auth.APIKey, options ...Option) (inference.Client, error)`. It binds provider identity `snowflake-cortex` and resolves the base below when Model.BaseURL is empty, unless the dynamic rule says otherwise.

| Field | Source-backed behavior |
| --- | --- |
| Package | `github.com/looprig/llm/providers/snowflake-cortex` (package `snowflake`) |
| Provider | `snowflake-cortex` |
| Formats | OpenAI |
| Default base | dynamic: account Snowflake Cortex URL |
| Authentication | account token |
| Header or signer | Authorization: Bearer |
| Options | WithAccount; WithHeader; WithReasoningEnabled; WithServiceTier |

Token falls back from SNOWFLAKE_CORTEX_TOKEN to SNOWFLAKE_CORTEX_PAT. Account is required only when BaseURL is empty.
...
conversation_complete is normalized to an empty response. No general response retry is declared.
...
func invoke() error {
    ...
    selected := model.CustomModel(model.ProviderName("snowflake-cortex"), model.APIFormatOpenAI, "", "model-name")
    // Construction validates provider policy and binds its endpoint and codec.
    client, err := snowflake.New(selected, auth.APIKey(os.Getenv("SNOWFLAKE_CORTEX_API_KEY")))
...
- [client.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/snowflake-cortex/client.go)
- [counter.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/snowflake-cortex/counter.go)
- [errors.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/snowflake-cortex/errors.go)
...
- [client_error_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/snowflake-cortex/client_error_test.go)
- [client_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/snowflake-cortex/client_test.go)
- [normalize_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/snowflake-cortex/normalize_test.go)
- [options_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/snowflake-cortex/options_test.go)
- [validation_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/snowflake-cortex/validation_test.go)
