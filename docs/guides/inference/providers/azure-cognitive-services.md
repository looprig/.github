---
id: guides/inference/providers/azure-cognitive-services
title: Azure Cognitive Services
description: Configure the Azure Cognitive Services provider from its released llm package, including endpoint, auth, formats, capabilities, counters, and failure boundaries.
audience: developer
section: guides
order: 7
...
Compatibility client that chooses Chat, Responses, or Anthropic routing from APIFormat.

## Contract and endpoint

The public constructor is `func New(selected model.Model, key auth.APIKey, options ...Option) (inference.Client, error)`. It binds provider identity `azure-cognitive-services` and resolves the base below when Model.BaseURL is empty, unless the dynamic rule says otherwise.

| Field | Source-backed behavior |
| --- | --- |
| Package | `github.com/looprig/llm/providers/azure-cognitive-services` (package `azurecognitive`) |
| Provider | `azure-cognitive-services` |
| Formats | OpenAI, OpenAI Responses, Anthropic |
| Default base | dynamic: Azure Cognitive Services resource endpoint |
| Authentication | API key |
| Header or signer | Authorization: Bearer |
| Options | WithResourceName; WithHeader; WithThinkingBudget |

The resource comes from WithResourceName or AZURE_COGNITIVE_SERVICES_RESOURCE_NAME. Anthropic adds anthropic-version 2023-06-01.
...
func invoke() error {
    ...
    selected := model.CustomModel(model.ProviderName("azure-cognitive-services"), model.APIFormatOpenAI, "", "model-name")
    // Construction validates provider policy and binds its endpoint and codec.
    client, err := azurecognitive.New(selected, auth.APIKey(os.Getenv("AZURE_COGNITIVE_SERVICES_API_KEY")))
...
- [client.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/azure-cognitive-services/client.go)
- [counter.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/azure-cognitive-services/counter.go)
- [errors.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/azure-cognitive-services/errors.go)
- [options.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/azure-cognitive-services/options.go)
...
- [client_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/azure-cognitive-services/client_test.go)
- [counter_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/azure-cognitive-services/counter_test.go)
- [default_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/azure-cognitive-services/default_test.go)
