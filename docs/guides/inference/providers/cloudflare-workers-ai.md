---
id: guides/inference/providers/cloudflare-workers-ai
title: Cloudflare Workers AI
description: Configure the Cloudflare Workers AI provider from its released llm package, including endpoint, auth, formats, capabilities, counters, and failure boundaries.
audience: developer
section: guides
order: 14
...
The public constructor is `func New(selected model.Model, key auth.APIKey, options ...Option) (inference.Client, error)`. It binds provider identity `cloudflare-workers-ai` and resolves the base below when Model.BaseURL is empty, unless the dynamic rule says otherwise.

| Field | Source-backed behavior |
| --- | --- |
| Package | `github.com/looprig/llm/providers/cloudflare-workers-ai` (package `cloudflareworkers`) |
| Provider | `cloudflare-workers-ai` |
| Formats | OpenAI |
| Default base | dynamic: account-scoped Cloudflare API v4 AI route |
| Authentication | API key |
| Header or signer | Authorization: Bearer |
| Options | WithAccountID; WithGatewayID; WithHeader |
...
func invoke() error {
    ...
    selected := model.CustomModel(model.ProviderName("cloudflare-workers-ai"), model.APIFormatOpenAI, "", "model-name")
    // Construction validates provider policy and binds its endpoint and codec.
    client, err := cloudflareworkers.New(selected, auth.APIKey(os.Getenv("CLOUDFLARE_WORKERS_AI_API_KEY")))
...
- [client.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-workers-ai/client.go)
- [counter.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-workers-ai/counter.go)
- [errors.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-workers-ai/errors.go)
...
- [client_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-workers-ai/client_test.go)
