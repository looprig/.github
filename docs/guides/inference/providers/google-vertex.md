...
- [client.go](https://github.com/looprig/llm/blob/v0.15.0/providers/google-vertex/client.go)
- [counter.go](https://github.com/looprig/llm/blob/v0.15.0/providers/google-vertex/counter.go)
- [errors.go](https://github.com/looprig/llm/blob/v0.15.0/providers/google-vertex/errors.go)
...
- [client_test.go](https://github.com/looprig/llm/blob/v0.15.0/providers/google-vertex/client_test.go)
- [validation_test.go](https://github.com/looprig/llm/blob/v0.15.0/providers/google-vertex/validation_test.go)
