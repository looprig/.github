---
id: guides/inference/providers/minimax
title: MiniMax
description: Configure the MiniMax provider from its released llm package, including endpoint, auth, formats, capabilities, counters, and failure boundaries.
audience: developer
section: guides
order: 33
...
Native Anthropic-compatible Messages wrapper for MiniMax.

## Contract and endpoint

The public constructor is `func New(selected model.Model, key auth.APIKey, options ...Option) (inference.Client, error)`. It binds provider identity `minimax` and resolves the base below when Model.BaseURL is empty, unless the dynamic rule says otherwise.

| Field | Source-backed behavior |
| --- | --- |
| Package | `github.com/looprig/llm/providers/minimax` (package `minimax`) |
| Provider | `minimax` |
| Formats | Anthropic |
| Default base | https://api.minimax.io/anthropic/v1 |
| Authentication | API key |
| Header or signer | x-api-key |
| Options | WithHeader; WithThinkingBudget |

Always applies anthropic-version 2023-06-01. OpenAI and Responses are rejected by provider validation.
...
import (
    ...
    minimax "github.com/looprig/llm/providers/minimax"
)
func invoke() error {
    // Resolve credentials from an application-owned lease or environment, never model.Model.
    selected := model.CustomModel(model.ProviderName("minimax"), model.APIFormatAnthropic, "", "model-name")
    // Construction validates provider policy and binds its endpoint and codec.
    client, err := minimax.New(selected, auth.APIKey(os.Getenv("MINIMAX_API_KEY")))
...
- [client.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/minimax/client.go)
- [counter.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/minimax/counter.go)
- [errors.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/minimax/errors.go)
- [options.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/minimax/options.go)
...
- [client_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/minimax/client_test.go)
- [counter_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/minimax/counter_test.go)
