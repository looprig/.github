---
id: guides/inference/providers/deepinfra
title: Deep Infra
description: Configure the Deep Infra provider from its released llm package, including endpoint, auth, formats, capabilities, counters, and failure boundaries.
audience: developer
section: guides
order: 16
...
The public constructor is `func New(selected model.Model, key auth.APIKey, options ...Option) (inference.Client, error)`. It binds provider identity `deepinfra` and resolves the base below when Model.BaseURL is empty, unless the dynamic rule says otherwise.

| Field | Source-backed behavior |
| --- | --- |
| Package | `github.com/looprig/llm/providers/deepinfra` (package `deepinfra`) |
| Provider | `deepinfra` |
| Formats | OpenAI, Anthropic |
| Default base | OpenAI https://api.deepinfra.com/v1/openai; Anthropic https://api.deepinfra.com/anthropic/v1 |
| Authentication | API key |
| Header or signer | Authorization: Bearer |
| Options | WithHeader; WithReasoningEffort; WithThinkingEnabled |
...
| Format gate | OpenAI, Anthropic; unsupported values fail model validation before I/O |
...
func invoke() error {
    ...
    selected := model.CustomModel(model.ProviderName("deepinfra"), model.APIFormatOpenAI, "", "model-name")
    // Construction validates provider policy and binds its endpoint and codec.
    client, err := deepinfra.New(selected, auth.APIKey(os.Getenv("DEEPINFRA_API_KEY")))
...
- [client.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/deepinfra/client.go)
- [counter.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/deepinfra/counter.go)
- [errors.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/deepinfra/errors.go)
- [options.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/deepinfra/options.go)
...
- [client_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/deepinfra/client_test.go)
- [counter_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/deepinfra/counter_test.go)
