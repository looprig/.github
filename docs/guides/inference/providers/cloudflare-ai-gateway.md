---
id: guides/inference/providers/cloudflare-ai-gateway
title: Cloudflare AI Gateway
description: Configure the Cloudflare AI Gateway provider from its released llm package, including endpoint, auth, formats, capabilities, counters, and failure boundaries.
audience: developer
section: guides
order: 13
...
The public constructor is `func New(selected model.Model, key auth.APIKey, options ...Option) (inference.Client, error)`. It binds provider identity `cloudflare-ai-gateway` and resolves the base below when Model.BaseURL is empty, unless the dynamic rule says otherwise.

| Field | Source-backed behavior |
| --- | --- |
| Package | `github.com/looprig/llm/providers/cloudflare-ai-gateway` (package `cloudflaregateway`) |
| Provider | `cloudflare-ai-gateway` |
| Formats | OpenAI |
| Default base | dynamic: account-scoped Cloudflare API v4 AI route |
| Authentication | API key |
| Header or signer | Authorization: Bearer |
| Options | WithAccountID; WithGatewayID; WithHeader; WithMetadata; WithSkipCache; WithCacheTTL; WithCacheKey; WithCollectLog; WithReasoningEffort; WithThinkingBudget |
...
func invoke() error {
    ...
    selected := model.CustomModel(model.ProviderName("cloudflare-ai-gateway"), model.APIFormatOpenAI, "", "model-name")
    // Construction validates provider policy and binds its endpoint and codec.
    client, err := cloudflaregateway.New(selected, auth.APIKey(os.Getenv("CLOUDFLARE_AI_GATEWAY_API_KEY")))
...
- [client.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-ai-gateway/client.go)
- [counter.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-ai-gateway/counter.go)
- [errors.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-ai-gateway/errors.go)
...
- [client_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-ai-gateway/client_test.go)
- [options_test.go](https://github.com/looprig/llm/blob/107b378c3882c0a99ad98e36d89e542c5461bc55/providers/cloudflare-ai-gateway/options_test.go)
