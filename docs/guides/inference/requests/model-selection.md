...
- Source: [`inference/client.go`](https://github.com/looprig/inference/blob/v0.14.0/client.go), [`inference/model/model.go`](https://github.com/looprig/inference/blob/v0.14.0/model/model.go)
- Tests: [`inference/model/model_test.go`](https://github.com/looprig/inference/blob/v0.14.0/model/model_test.go), [`inference/model/modelkey_test.go`](https://github.com/looprig/inference/blob/v0.14.0/model/modelkey_test.go)
