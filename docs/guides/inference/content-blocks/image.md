...
- Source: [`core/content/block.go`](https://github.com/looprig/core/blob/v0.12.0/content/block.go), [`core/content/media_type.go`](https://github.com/looprig/core/blob/v0.12.0/content/media_type.go)
- Tests: [`core/content/block_json_test.go`](https://github.com/looprig/core/blob/v0.12.0/content/block_json_test.go), [`inference/client_test.go`](https://github.com/looprig/inference/blob/v0.14.0/client_test.go)
