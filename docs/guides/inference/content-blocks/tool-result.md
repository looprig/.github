...
- Source: [`core/content/block.go`](https://github.com/looprig/core/blob/v0.12.0/content/block.go), [`core/content/block_json.go`](https://github.com/looprig/core/blob/v0.12.0/content/block_json.go)
