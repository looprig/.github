...
- Tests: [`inference/model/model_test.go`](https://github.com/looprig/inference/blob/v0.14.0/model/model_test.go) covers field validation, options, cloning, and non-aliasing.
