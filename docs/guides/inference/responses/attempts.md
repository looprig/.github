...
- Source: [`inference/client.go`](https://github.com/looprig/inference/blob/v0.14.0/client.go), [`inference/stream/result.go`](https://github.com/looprig/inference/blob/v0.14.0/stream/result.go)
- Tests: [`inference/stream/stream_test.go`](https://github.com/looprig/inference/blob/v0.14.0/stream/stream_test.go), [`inference/retry/invoke_test.go`](https://github.com/looprig/inference/blob/v0.14.0/retry/invoke_test.go)
