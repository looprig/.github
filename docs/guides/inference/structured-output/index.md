...
- Source: [`inference/output.go`](https://github.com/looprig/inference/blob/v0.14.0/output.go), [`inference/structured_result.go`](https://github.com/looprig/inference/blob/v0.14.0/structured_result.go), [`inference/structured_errors.go`](https://github.com/looprig/inference/blob/v0.14.0/structured_errors.go)
- Tests: [`inference/output_test.go`](https://github.com/looprig/inference/blob/v0.14.0/output_test.go), [`inference/structured_result_test.go`](https://github.com/looprig/inference/blob/v0.14.0/structured_result_test.go)
