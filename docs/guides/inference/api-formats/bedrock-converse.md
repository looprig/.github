...
- [`bedrockconverse/types.go`](https://github.com/looprig/inference/blob/v0.12.0/codec/bedrockconverse/types.go)
...
- [`bedrockconverse/stream_test.go`](https://github.com/looprig/inference/blob/v0.12.0/codec/bedrockconverse/stream_test.go)
