...
- [`openaiapi/codec.go`](https://github.com/looprig/inference/blob/v0.14.0/codec/openaiapi/codec.go)
- [`openaiapi/encode.go`](https://github.com/looprig/inference/blob/v0.14.0/codec/openaiapi/encode.go)
- [`openaiapi/decode.go`](https://github.com/looprig/inference/blob/v0.14.0/codec/openaiapi/decode.go)
- [`openaiapi/stream_test.go`](https://github.com/looprig/inference/blob/v0.14.0/codec/openaiapi/stream_test.go)
