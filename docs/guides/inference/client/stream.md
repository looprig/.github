...
- Source: [`inference/client.go`](https://github.com/looprig/inference/blob/main/client.go), [`inference/stream/stream.go`](https://github.com/looprig/inference/blob/main/stream/stream.go)
